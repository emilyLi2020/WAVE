...
After saving, the diagnostic
(models/finetune/diagnose_merged_base.py --source-repo <out-dir>) should be
re-run to confirm coherent generation before pushing or converting.
...
def main() -> None:
    ...
    print("Done. Next: run finetune/diagnose_merged_base.py --source-repo <out-dir>")
