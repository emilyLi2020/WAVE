...
namespace margelo::nitro::litertlm {
  ...
  public:
    LLMConfig() = default;
    explicit LLMConfig(std::optional<std::string> systemPrompt, std::optional<Backend> backend, std::optional<double> maxTokens, std::optional<double> engineMaxTokens, std::optional<double> outputMaxTokens, std::optional<double> temperature, std::optional<double> topK, std::optional<double> topP, std::optional<bool> validate): systemPrompt(systemPrompt), backend(backend), maxTokens(maxTokens), engineMaxTokens(engineMaxTokens), outputMaxTokens(outputMaxTokens), temperature(temperature), topK(topK), topP(topP), validate(validate) {}
