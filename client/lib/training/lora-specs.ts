...
const reflection: LoraFormSpec = {
  ...
  outputFields: [
    ...
    },
    {
      key: "nextSteps",
      kind: "object",
      label: "Four backup next-step chips",
      fields: [
        {
          key: "one",
          kind: "text",
