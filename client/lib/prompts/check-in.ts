...
export function buildCheckInPrompt(
  ...
  const sections: string[] = [
    ...
    "Floor: never call the tool before the patient has sent at least 2 messages after their score (so: score + 2 more patient messages, minimum). Also never call it before you have produced at least one validating reply.",
    "When you call the tool, do NOT also produce a final assistant text turn — your last text turn should already have closed the loop.",
    "</end_conversation_tool>",
    "",
    `<patient_score>`,
