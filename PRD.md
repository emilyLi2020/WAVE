...
PROCESS: Once the intake safety screen clears, WAVE runs a 12–15 minute
         ...
         web demo. Runtime routing selects `lora-check-in-1` through
         `lora-check-in-5` plus `lora-reflection` at close. The 5
